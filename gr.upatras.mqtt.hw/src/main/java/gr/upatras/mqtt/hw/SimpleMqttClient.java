...
// subscriber or both
	...
	public static final String TOPIC = "grupatras/lab/hw/1066579";
...
// publish messages if publisher
		if (publisher) {
				Date date = new Date();
				String pubMsg = "{Current date: " + date + "}";
				int pubQoS = 0;
				MqttMessage message = new MqttMessage(pubMsg.getBytes());
				message.setQos(pubQoS);
				message.setRetained(false);
// Publish the message
				log.info("Publishing to topic \"" + topic + "\" qos " + pubQoS + "\" current date: " + date);
